...
What Bitwarden does is applying the pbkdf2 function twice, the second time the first hash as password and the original password as salt. It's easier to read the code:
